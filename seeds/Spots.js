    ...
    .then(function () {
      ...
      return knex('Spots').insert([
        ...
        {spotName: 'Waitangi Park',
          ...
          activeUsers: 0,
          instaVid1: 'https://www.instagram.com/p/_F2C12MxTE/embed',
          instaVid2: 'https://www.instagram.com/p/BT-xLN9ArlZ/embed'},
        {spotName: 'Treetops', address: 'Off Edinburgh Tce. Behind the athletics track.', terrain: 'street, mini-ramp', comments: 'DIY park, child of Tom Cully & friends. In Newtown away from the main drag, Treetops is a park by skaters for skaters. One of the best places to spend a summer day with the crew, turn up with food and a few beers and settle in.', likes: 3, spotBanner: '/images/treetopsbanner.jpeg', activeUsers: 0, instaVid1: 'https://www.instagram.com/p/BJMvs06DnNV/embed', instaVid2: ''},
        {spotName: 'Karori Ramps', address: 'Curtis Street, Karori', terrain: 'miniramp, vert ramp!', comments: 'Ramps. Really nice ramps. Can get busy during summer since it\'s the best ramp section in town. Friendly crowd, great place to learn some new moves.', likes: 2, spotBanner: '/images/karoribanner.jpg', activeUsers: 0, instaVid1: 'https://www.instagram.com/p/BMPiZ1Og5dm/embed', instaVid2: 'https://www.instagram.com/p/BXZYgomgiyl/embed'},
        {spotName: 'Fusion', address: '89 Cuba Street', terrain: 'it\'s a shop', comments: 'Got a lovely pair of DC shoes here, say hi to Jack for me', likes: 1, spotBanner: '/images/fusionbanner.jpg', activeUsers: 0, instaVid1: '', instaVid2: ''},
        {spotName: 'Cheapskates', address: '60 Cuba Street', terrain: 'it\'s a shop', comments: 'Nick hooked me up with some wicked Vans here, he\'s the man', likes: 1, spotBanner: '/images/cheapskatesbanner.jpg', activeUsers: 0, instaVid1: '', instaVid2: ''}
      ])
    })
}
